...
from data.texture import DBreader_BVItexture, DBreader_DynTex, DBreader_SynTex, Sampler, HomTex
...
def train(args, epoch):
    ...
    for i, (im1, gt, im2) in enumerate(train_loader):
        ...
        if i % args.log_iter == 0:
            ...
            print('Train Epoch: {} [{}/{}]\tTime({:.2f})'.format(
                epoch, i, len(train_loader), time.time() - t))
